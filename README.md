...
For a detailed list of all the available packages, check out Debian and Ubuntu related pages [here](https://www.debian.org/distrib/packages) and [here](https://packages.ubuntu.com). Further documentation about *Minidot* can be found inside [**`DOCS.md`**](DOCS.md), take a look for more details.
