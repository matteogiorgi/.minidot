...
<img style="width:100%;" id="vim.png">
...
```
git curl wget stow htop xclip trash-cli fzf ripgrep bat chafa xdo poppler-utils
fonts-firacode wamerican witalian gnome-keyring dash bash bash-completion tmux vim-gtk3 pandoc
```
