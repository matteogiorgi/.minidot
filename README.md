...
Other usefull applications not included in this setup are: [VSCode](https://github.com/microsoft/vscode#readme) (check `reset-code`) and [Input&#x2011;Remapper](https://github.com/sezanzeb/input-remapper#readme).
