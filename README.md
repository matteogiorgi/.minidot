...
- [`code`](https://code.visualstudio.com/Download), [`code-insiders`](https://code.visualstudio.com/insiders/)
- [`google-chrome`](https://www.google.com/chrome/), [`brave`](https://brave.com/linux/)
- [`gnome-shell-extension-manager`](https://mattjakeman.com/apps/extension-manager), [`input-remapper`](https://github.com/sezanzeb/input-remapper#installation).
