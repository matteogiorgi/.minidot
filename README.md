...
Minidot is intended batteries-included but, if you want [more](https://apps.gnome.org/), you can always rely on `apt` (or `snap`) or download any deb package and install it through `dpkg`. Here few more goodies: [Sublime](https://www.sublimetext.com/docs/linux_repositories.html), [Merge](https://www.sublimemerge.com/docs/linux_repositories), [Code](https://code.visualstudio.com/Download), [Insiders](https://code.visualstudio.com/insiders/), [Chrome](https://www.google.com/chrome/), [Brave](https://brave.com/linux/), [Extension-Manager](https://github.com/mjakeman/extension-manager#-installing), [Input-Remapper](https://github.com/sezanzeb/input-remapper#installation).
