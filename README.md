...
- More applications: `input-remapper`, `diodon`,  `gparted`, `vlc`, `zim`, [`xournalpp`](https://xournalpp.github.io/installation/linux/), [`brave`](https://brave.com/linux/), [`code`](https://code.visualstudio.com/Download).
