...
- Gnome-specific applications: `gnome-calendar`, `gnome-contacts`, `geary`, `dconf-editor`.
- Manage Gnome extensions: `gnome-shell-extension-manager` or `gnome-shell-extensions` with `chrome-gnome-shell`.
