...
- Web bookmarks: [Startpage Devdocs Drive Mega Gmail Proton Outlook Discord Telegram](https://raw.githubusercontent.com/matteogiorgi/.minidot/master/bookmarks.html)
...
- 4Gnome: `dconf-editor`, `gnome-shell-extension-manager` (or `gnome-shell-extensions` + `chrome-gnome-shell`).
