...
- Applications: `gparted`, `vlc`, `input-remapper`, `diodon`, `zim`, [`xournalpp`](https://xournalpp.github.io/installation/linux/), [`brave`](https://brave.com/linux/), [`code`](https://code.visualstudio.com/Download).
- Gnome: `dconf-editor`, `gnome-shell-extension-manager` (or `gnome-shell-extensions` + `chrome-gnome-shell`).
