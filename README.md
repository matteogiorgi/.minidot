...
This repo already contains all the tools you need to work proficiently but, if you want [more](https://apps.gnome.org/), you can always rely on `apt` (or `snap`) or download the official deb package and install it through `dpkg`. Here few goodies: [`helix`](https://docs.helix-editor.com/install.html), [`code`](https://code.visualstudio.com/Download), [`sublime`](https://www.sublimetext.com/docs/linux_repositories.html), [`google-chrome`](https://www.google.com/chrome/), [`brave`](https://brave.com/linux/), [`extension-manager`](https://github.com/mjakeman/extension-manager#-installing), [`input-remapper`](https://github.com/sezanzeb/input-remapper#installation).
