...
- Applications: `gparted`, `vlc`, `input-remapper`, `diodon`, `zim`, [`xournalpp`](https://xournalpp.github.io/installation/linux/), [`brave`](https://brave.com/linux/), [`chrome`](https://www.google.com/chrome/), [`code`](https://code.visualstudio.com/Download), [`insiders`](https://code.visualstudio.com/insiders/).
